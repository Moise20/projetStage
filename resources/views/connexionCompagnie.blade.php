@extends('layouts.layoutConnexionCompagnie')
@section('contenu')
<form class="form-horizontal m-t-20" id="loginform" action="/connexionCompagnie" method="post">
    {{ csrf_field() }}
    ...
    <div class="row border-top border-secondary">
        <div class="col-12">
            <div class="form-group">
                <div class="p-t-20">
                    <a href="/password-resetCompagnie">
