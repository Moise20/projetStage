@extends('layouts.layoutAffichageTrajetDispo')
@section('contenu')
<div class="card">
    <div class="card-body">
            ...
            <tbody class="customtable">
               @foreach($trajets as $trajet)
                <tr>
                    ...
                    <td>{{$trajet->agence_id}}</td>
                   
                    <td>
                        <a href="{{route('reserverTrajet.show', [$trajet->id]) }}">
                            <div class="field">
                                <div class="control">
                                    <button class="button is-link" type="submit">Reserver</button>
                                </div>
                            </div>
                        </a>
                    </td>
