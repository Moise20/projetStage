@extends('layouts.layoutPasswordCompagnie')
@section('contenu')
<form class="form-horizontal m-t-20" id="loginform" action="/reset-passwordCompagnie" method="post">
    {{ csrf_field() }}
        ...
        <div class="col-12">
            <div class="form-group">
                <div class="p-t-20">
                    ...
                    <a class="btn btn-success" href="/connexionCompagnie" id="to-login">Page Connexion</a>
