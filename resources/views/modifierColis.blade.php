@extends('layouts.layoutModifierColis')
@section('contenu')
<form action="/modifierColis" method="post" class="form-horizontal m-t-20" enctype="multipart/form-data">
    {{ csrf_field() }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="nom" placeholder="Nom du colis Ici" value="{{ $nom }}" required>
                        </div>
                        <div>
                            @if($errors->has('nom'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group mb-3">
                            ...
                            <input type="number" min="1" class="form-control" name="poids" placeholder="poids du colis en kg Ici" value="{{ $poids}}" required>
                        </div>
                        <div>
                            @if($errors->has('poids'))
                            <p class="alert-danger">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="nomDestinataire" placeholder="Nom du destinataire Ici" value="{{ $nomDestinataire }}" required>
                        </div>
                        <div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group mb-3">
                            ...
                            <input type="tel" class="form-control" name="numTelDestinataire" placeholder="Tel du destinataire Ici" value="{{ $numTelDestinataire }}" pattern="[0-9]{8}" required>
                        </div>
                        <div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group mb-3">
                            ...
                            <input type="date" class="form-control" name="dateConvoyage" placeholder="Date De convoyage Ici" value="{{ $dateConvoyage }}" required>
                        </div>
                        <div>
