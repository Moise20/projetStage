                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="bg-dark p-10 text-white text-center">
                                                            ...
                                                            <small class="font-light">Utilisateurs Total</small>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="bg-dark p-10 text-white text-center">
                                                            <i class="fa fa-user m-b-5 font-16"></i>
                                                            <h5 class="m-b-0 m-t-5">{{$clients}}</h5>
                                                    ...
                                                    <div class="col-6 m-t-15">
                                                        <div class="bg-dark p-10 text-white text-center">
                                                            ...
                                                            <h5 class="m-b-0 m-t-5">{{$compagnies}}</h5>
                                                            <small class="font-light">Compagnies</small>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 m-t-15">
                                                        <div class="bg-dark p-10 text-white text-center">
