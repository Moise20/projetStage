                    ...
                    <ul class="navbar-nav float-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown" aria-labelledby="2">
                                <ul class="list-style-none">
                                    <li>
                                        <div class="">
                                            <!-- Message -->
                                            <a href="/listeColis" class="link border-top">
                                                <div class="d-flex no-block align-items-center p-10">
                                                    <span class="btn btn-success btn-circle"><i class="fa fa-table"></i></span>
                                                    <div class="m-l-10">
                                                        <h5 class="m-b-0">Colis</h5>
                                                        <span class="mail-desc">Toucher pour voir les informations</span>
                                                    </div>
                                                </div>
                                            </a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/deconnexionClient"><i class="fa fa-power-off m-r-5 m-l-5"></i> Deconnection </a>
