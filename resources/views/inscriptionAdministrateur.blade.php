@extends('layouts.layoutinscriptionAdministrateur')
@section('contenu')
<!-- Form -->
<form action="/inscriptionAdministrateur" method="post" class="form-horizontal m-t-20">
    {{ csrf_field() }}
    ...
    <div class="row border-top border-secondary">
        <div class="col-12">
            <div class="form-group">
                <div class="p-t-20">
                    <a href="/connexionAdministrateur">
