@extends('layouts.layoutconnexionAdministrateur')
@section('contenu')
<form class="form-horizontal m-t-20" id="loginform" action="/connexionAdministrateur" method="post">
    {{ csrf_field() }}
        ...
        <div class="col-12">
            <div class="form-group">
                <div class="p-t-20">
                    ...
                    <a href="/inscriptionAdministrateur">
    ...
    <div class="row p-b-30">
        <div class="col-12">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control form-control-lg" name="email" value="{{ old('email') }}" placeholder=" Addresse Email" aria-label="Username" aria-describedby="basic-addon1" required>
            </div>
            <div>
                @if($errors->has('email'))
