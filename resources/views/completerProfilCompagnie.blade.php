@extends('layouts.layoutCompleterProfilCompagnie')
@section('contenu')
<form action="/completerProfilCompagnie" method="post" class="form-horizontal m-t-20" enctype="multipart/form-data">
    {{ csrf_field() }}
